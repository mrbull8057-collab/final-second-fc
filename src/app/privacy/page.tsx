  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#080808]">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 sm:px-6 py-12 w-full">
        <h1 className="text-lg font-bold text-white mb-4">Privacy Policy</h1>
        <div className="space-y-3 text-sm text-zinc-500 leading-relaxed">
          <p>We may collect information you provide (name, email) when you contact us, plus anonymous usage data.</p>
          <p>We never sell or share your personal data. We use it only to improve the site and respond to you.</p>
          <p>This site may use cookies for basic functionality. Disable in your browser if desired.</p>
          <p>Questions? Reach out via the <Link href="/contact" className="text-red-400 hover:text-red-300">Contact</Link> page.</p>
        </div>
      </main>
